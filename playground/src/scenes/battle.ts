...
export function setBattle(instance: KaboomCtx, worldState: WorldState) {
  ...
  function reduceHealth(healthBar: GameObj<PosComp | RectComp | ColorComp>, damageDealt: number) {
    tween(
      healthBar.width,
  ...
  function makeMonFlash(mon: typeof playerMon) {
    tween(
      mon.opacity,
      0,
      0.3,
  ...
  function colorizeHealthBar(healthBar: typeof playerMonHealthBar) {
  ...
  function makeMonDrop(mon: typeof enemyMon) {
    tween(
      mon.pos.y,
      800,
      0.5,
